...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/OtherEntityFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/SomeEntityFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\OtherEntityFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\SomeEntityFixtures(), 'groups' => []]]);
