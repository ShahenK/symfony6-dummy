...
class getUx_TwigComponent_ComponentRendererService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['ux.twig_component.component_renderer'] = new \Symfony\UX\TwigComponent\ComponentRenderer($a, $b, ($container->privates['ux.twig_component.component_factory'] ?? $container->load('getUx_TwigComponent_ComponentFactoryService')), ($container->privates['property_accessor'] ?? $container->load('getPropertyAccessorService')), new \Symfony\UX\TwigComponent\ComponentStack());
    }
}
